...
import { gray, white, calendarHighlight } from "../styles/styles";

import configureStore from "../configureStore"
import rootReducer from "../reducers"; // tu dong pointer vao file index (js default)
...
const Navigation = createStackNavigator({
      ...
      headerRight: (
        <TouchableOpacity onPress={() => navigation.navigate("AddTask")}>
          <Image
            ...
            source={{
              uri:
                "data:image/png;base64,"
            }}
          />
        </TouchableOpacity>
      ),
  ...
  AddTask: {
    ...
    navigationOptions: ({ navigation }) => ({
      ...
      headerLeft: (
        <TouchableOpacity onPress={() => navigation.navigate("Schedule")}>
          <Image
            ...
            source={{
              uri:
                "data:imsage/png;base64,"
            }}
          />
        </TouchableOpacity>
      ),
      headerRight: (
        <TouchableOpacity onPress={navigation.getParam("addTask")}>
          <Text
            style={{
              marginEnd: 10,
              fontWeight: "bold",
      ...
      headerStyle: {
        backgroundColor: white,
        borderBottomWidth: 0 // not working
      }
    })
  }
});
